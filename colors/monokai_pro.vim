...
" Default group
hi Cursor ctermfg=236 ctermbg=231 cterm=NONE guifg=#2d2a2e guibg=#ebebeb gui=NONE
...
hi StatusLine ctermfg=231 ctermbg=59 cterm=bold guifg=#ebebeb guibg=#696769 gui=bold
hi StatusLineNC ctermfg=231 ctermbg=59 cterm=NONE guifg=#ebebeb guibg=#696769 gui=NONE
...
hi Normal ctermfg=231 ctermbg=236 cterm=NONE guifg=#ebebeb guibg=#2d2a2e gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#ebebeb guibg=#47840e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0809 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#ebebeb guibg=#273a5b gui=NONE
hi DiffText ctermfg=231 ctermbg=24 cterm=bold guifg=#ebebeb guibg=#204a87 gui=bold
...
hi Title ctermfg=231 ctermbg=NONE cterm=bold guifg=#ebebeb guibg=NONE gui=bold
hi Todo ctermfg=231 ctermbg=NONE cterm=inverse,bold guifg=#ebebeb guibg=NONE gui=inverse,bold,italic
...
hi rubyGlobalVariable ctermfg=231 ctermbg=NONE cterm=NONE guifg=#ebebeb guibg=NONE gui=NONE
...
hi rubyClassVariable ctermfg=231 ctermbg=NONE cterm=NONE guifg=#ebebeb guibg=NONE gui=NONE
...
hi yamlAnchor ctermfg=231 ctermbg=NONE cterm=NONE guifg=#ebebeb guibg=NONE gui=NONE
hi yamlAlias ctermfg=231 ctermbg=NONE cterm=NONE guifg=#ebebeb guibg=NONE gui=NONE
...
" GraphQL
hi graphqlType ctermfg=231 ctermbg=236 cterm=NONE guifg=#ebebeb guibg=#2d2a2e gui=NONE
